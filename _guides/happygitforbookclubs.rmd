---
title: "Happy Git For Bookclubs"
subtitle: "2/2: Setting Up Your Local Machine"
author: Tan Ho
date: "`r Sys.Date()`"
output: 
  html_document:
...
This next video summarises the happiest way to set up a copy of a GitHub repository on your computer and to interact with it. This video assumes that you have Git installed, if you do not, please check out https://happygitwithr.com/install-git.html. 

In fact, you probably want to read https://happygitwithr.com cover to cover - EIKIFJB.
...
I prefer the terminal for git. Asmae Toumi tells me that there's a GUI in RStudio for it. Pshaw.
